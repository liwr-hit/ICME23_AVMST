...
from src.model_improvements import AVMST
...
def get_evaluation():
    ...
    if  args.ale==False and args.sje==False and args.devise==False and args.apn==False and args.cjme==False and args.AVMST==False:
        ...
        model_A=CJME(config)
    elif args.AVMST==True:
        model_A =AVMST(params_model=model_params, input_size_audio=config.input_size_audio,input_size_video=config.input_size_video)
